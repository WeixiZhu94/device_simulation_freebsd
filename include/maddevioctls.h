...
#define MADDEVOBJ_IOC_CTX_CREATE         _IO(MADDEVOBJ_IOC_MAGIC, MADDEVOBJ_IOC_INDEX_BASE+13, unsigned long)
#define MADDEVOBJ_IOC_LAUNCH_KERNEL      _IO(MADDEVOBJ_IOC_MAGIC, MADDEVOBJ_IOC_INDEX_BASE+14, void*)
